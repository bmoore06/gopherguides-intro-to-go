package main // You will always need this at the beginning of the go code.

import ( // You will always need this at the beginning of your go code as well in order to import certain packages.
	"errors"
	"fmt"
)
